# ETCD for Beginners
 ...
 ## What is a ETCD?
     - ETCD is a distributed reliable key-value store that provides a reliable way to store the data 
       that needs to be accessed by a distributed system or cluster of machines.  This is simple, secure & Fast.
